      ...
      <div style="width: 400px; margin: 0 auto;">
         <div style="margin: 0 auto;">
            ...
            <div>
               ...
               <button type="submit"
                  style="width: 80px; height: 40px; color: #4B62D3; background-color: white; font-size: 9pt; border: 1px solid #4B62D3">
                  <span class="glyphicon glyphicon-search"></span>&nbsp;재검색
               </button>
               </div>
               
               <br> <br> <input type="text" name="query" id="detail_addr"
                  placeholder="상세 주소를 입력하세요" style="width: 380px; height: 50px;"><br>
               <br>
               ...
               <p>
                  <button type="button" onclick="sendValue();"
                     style="width: 380px; height: 50px; background-color: #4B62D3; color: white;">저장</button>
               </p>
               <br> <br>
