...
<div class="title2_container">
	...
	<form action="../search/searchItem.jsp" method="post" name="search">
		<div class="search"">
			...
			style= "width: 400px; float: left; border: 1.5px solid; border-radius: 8px; font-size: 15px; margin-left: 30px; height: 50px; margin-top: 60px; padding-left: 20px;">
			<button type="submit" style="border: 0px; background-color: white;">
				<img src="image/searchicon.png"
					style="width: 20px; margin-top: 60px;">
			</button>
		</div>
	</form>
