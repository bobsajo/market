window.addEventListener('DOMContentLoaded',function(){ 
    ...
    $(document).ready(function() {
        ...
        var start_price = $(".price1").val();  // 개당가격 표시할 변수!
       ...
       // console.log(cost);
        ...
        $('.price .num').text(new Intl.NumberFormat('ko-KR').format(parseInt(start_price))+"원");             // 첫 화면의 총 상품금액 (.price 안에 .num) 에다가 초기 가격을 출력!
