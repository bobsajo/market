...
# 상품 클릭
    ...
    #id: review의 class: e36z05c0의 tag_nae: p => 리뷰 내용
        ...
        for r in rivew:
            ...
            rivew_date = r.find_element(By.CLASS_NAME,'e1bup33p0').text
            # 리스트에 넣기
            item_list.append([item_num,rivew_text,rivew_date])
...
item_list = pd.DataFrame(data=item_list,columns=['item_num','rivew','rivew_date'])
item_list.to_csv('C:\sist1226\getMaket\_realFolder\_rivew4.csv')