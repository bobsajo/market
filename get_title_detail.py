...
# 상품 클릭
    ...
    # 리스트에 넣기
        ...
        info_list.append([item_name, ori_img, detail_img,sub_title,price,delivery_title,
        delivery_detail,seller,package_title,package_detail,
...
item_list = pd.DataFrame(data=info_list,columns=['item_name', 'ori_img', 'detail_img','sub_title','price',
'delivery_title','delivery_detail','seller','package_title',
'package_detail','sell_unit','weight','origin','allergy','info'])
item_list.to_csv('C:\sist1226\getMaket\sangpum.csv')